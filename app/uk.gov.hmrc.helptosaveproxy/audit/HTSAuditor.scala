...
@ImplementedBy(classOf[HTSAuditorImpl])
trait HTSAuditor {
...
@Singleton
class HTSAuditorImpl @Inject() (val auditConnector: AuditConnector)(implicit transformer: LogMessageTransformer) extends Logging {
